...
use Gongarce\ProductProps\Filament\Resources\ProductPropsExtension;
use Gongarce\ProductProps\Filament\Resources\ProductResource\MyProductResourceExtension;
use Gongarce\ProductProps\Filament\Resources\ProductResource\Pages\EditWithProperties;
...
class ProductPropsPlugin implements Plugin
{
    ...
    public function register(Panel $panel): void
    {
        ...
        LunarPanel::extensions([
            \Lunar\Admin\Filament\Resources\ProductResource::class => ProductPropsExtension::class,
        ]);

        FilamentIcon::register([
            'lunar::product-props' => 'lucide-list',
        ]);
    }
